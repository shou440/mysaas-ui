    ...
    <div id="devpage-row1">
      ...
      <div class="row1-body">
        ...
        <div id="devpage-foot">
          ...
          <myinfo title="电价(kwh)" frcolor="#FFFFFF" :content="currentmonthEP" />
          <myinfo title="上月(kwh)" frcolor="#FFFFFF" :content="lastMonthEP" />
          <myinfo title="今日(kwh)" frcolor="#FFFFFF" :content="todayEP" />
          <myinfo title="" content="" />
        </div>
      </div>
      <div class="devitem-magrin-gap" />
