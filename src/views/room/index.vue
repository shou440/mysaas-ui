<template>
  <div class="app-container">
    <el-dialog
      ...
      width="30%"
    >
      <addroom ref="roomlg" @onclickOK="onNewDlgOK" @onNewRoomDlgclickCancel="onNewRoomDlgclickCancel" />
    ...
    <el-dialog
      ...
      width="30%"
    >
      <addmeter ref="meterdlg" @onBindMeterOK="onBindMeterOK" @onBindMeterCancel="onBindMeterCancel" />
    ...
    <el-dialog
      ...
      width="30%"
    >
      <setmeter ref="setmeterdlg" @onclickOK="onSetMeterDlgOK" @onClickCancel="onSetmeterDlgCancel" />
    ...
    <el-dialog
      ...
      width="30%"
    >
      <addwmeter ref="wmeterdlg" @onBindWMeterOK="onBindWMeterOK" @onBindWMeterCancel="onBindWMeterCancel" />
    ...
    <el-dialog
      ...
      width="30%"
    >
      <setwmeter ref="setwmeterdlg" @onclickOK="onSetWMeterDlgOK" @onClickCancel="onSetwmeterDlgCancel" />
    ...
    <el-dialog
      ...
      width="50%"
    >
      <lessorconfirm ref="lessordlg" @onclickOK="onlessorconfirmDlgOK" @onClickCancel="onlessorconfirmDlgCancel" />
        ...
        <el-card class="user-center">
          <el-row type="flex" justify="space-start">
            <el-col :span="4" class="room-filter">
              <el-input v-model="roomfilter.roomname" placeholder="房间号" size="mini" />
            </el-col>
            <el-col :span="8" class="room-filter">
              <el-input v-model="roomfilter.roomdec" placeholder="租户名称" size="mini" />
            </el-col>
            ...
            <el-col :span="24" class="room-filter">
              ...
              >
                ...
                <el-table-column label="操作" prop="managefee" width="150" align="center">
                  <template slot-scope="scope">
                    <el-link v-if="scope.row.room_status===1" type="success" icon="el-icon-s-open" @click="unlessor(scope.row)">退租</el-link>
                    <el-link v-else type="primary" icon="el-icon-table-lamp" @click="lessor(scope.row)">出租</el-link>
              ...
              <div class="user" style="width: 600px">
                ...
                >
                  ...
                  <el-form-item>
                    ...
                    <el-button v-if="currentroominfo.has_edit===true" type="primary" @click="modifyRoom">确定修改</el-button>
                    <el-button v-if="currentroominfo.has_edit===false" type="primary" disabled="" @click="modifyRoom">确定修改</el-button>
              ...
              <div style="width: 500px">
                <el-form ref="mailForm" :model="currentroominfo" label-width="100px" class="demo-ruleForm">
                  ...
                  <el-form-item label="租户微信">
                    <el-row>
                      <el-col :span="8">
                        <el-avatar shape="circle" :src="tenantInfo.tenant_img" :size="40" />
                      </el-col>
                      <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    loadRoom() {
      ...
      if (_this.$store.state.area.currentarea != null) {
        ...
        _this.$store.dispatch('GetRoomList', _this.roomfilter).then(() => {
          ...
          if (_this.roomlist != null) // 如果有园区则选择默认园区
          {
    ...
    loadMeter() {
      var _this = this
      if (_this.$store.state.area.currentarea != null &&
          _this.$store.state.room.currentroom != null) {
