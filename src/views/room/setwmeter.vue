<template>
  <div>
    ...
    >
      ...
      <el-form-item>
        <el-button v-if="IsPriceValidate === true && IsEpbaseValidate === true" type="primary" @click="onclickok">确定</el-button>
        <el-button v-else type="primary" disabled @click="onclickok">确定</el-button>
...
export default {
  ...
  mounted() {
    var _this = this
    this.$nextTick(() => {
      if (_this.$store.state.wmeter.currentwmeter != null) {
