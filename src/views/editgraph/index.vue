<template>
  <div class="container-div">
    <el-dialog
      ...
      width="40%"
    >
      <filedlg ref="setmeterdlg" :file-content="mapContent" @onclickOK="onFileDlgOK" @onClickCancel="onFileDlgCancel" />
    </el-dialog>
    <el-dialog
      ...
      width="40%"
    >
      <fileopendlg ref="fileopendlg" @onFileOpenDlgOK="onFileOpenDlgOK" @onFileOpenDlgCancel="onFileOpenDlgCancel" />
    </el-dialog>
    <div class="toolbar-div">
      <el-collapse v-model="activeName">
        <el-collapse-item title="基本图形" name="1">
          <div ref="toolbarbasic" class="mytoolbar" />
        </el-collapse-item>
    ...
    <div class="right-pannel">
      ...
      <div class="content-pannel">
        <div ref="mygraphDiv" class="canvas-pannel" />
        <div v-if="isDspAttributePannel===true" class="attribute-pannel">
            ...
            <el-tab-pane label="样式" name="styletab">
              <div style="width: 100%; display: inline">
                <el-row type="flex" justify="space-around" align="middle">
                  ...
                  <el-col :span="15">
                    <el-select v-model="curStyleName" size="mini" placeholder="请选择" @change="onSelStyle">
                      <el-option
                ...
                <el-row type="flex" justify="space-around" align="middle">
                  <el-col :span="2" />
                  <el-col :span="15">
                    <el-checkbox v-model="curCellStyle.Fill" size="mini" @change="onStyleChange">填充</el-checkbox>
                  </el-col>
                  <el-col :span="6">
                    <el-color-picker
                ...
                <el-row type="flex" justify="space-around" align="middle">
                  <el-col :span="2" />
                  <el-col :span="15">
                    <el-checkbox v-model="curCellStyle.Gradient" size="mini" @change="onStyleChange">渐进填充</el-checkbox>
                  </el-col>
                  <el-col :span="6">
                    <el-color-picker
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(function() {
      if (!mxClient.isBrowserSupported()) {
        ...
        const xx = encoder.encode(_this.graph.getModel())
  ...
  methods: {
    ...
    exportXml() {
      ...
      const MxCodec = mxCodec
      const encoder = new MxCodec()
      const xx = encoder.encode(this.graph.getModel())
      var xml = mxUtils.getXml(xx)
