<template>
  <div class="charge-container">
    ...
    <div class="input-div">
      <el-input v-model="meter.meter_id" placeholder="6位电表编号" disabled="true" size="mini" />
    </div>

    <div class="label-div"><div>房间编号:</div></div>
    <div class="input-div">
      <el-input v-model="meter.room_name" disabled="true" size="mini" />
    </div>
    <div class="label-div"><div>退款金额(元):</div></div>
    <div class="input-div">
      <el-input v-model="drawback_fee" size="mini" />
    </div>
...
export default {
  ...
  methods: {
    ...
    // 点击添加房间
    onclickOK() {
      this.$emit('onclickOK', this.drawback_fee)
    },
    // 取消按钮
    onclickCancel() {
