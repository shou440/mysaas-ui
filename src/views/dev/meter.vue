<template>
  <div class="app-container">
    <el-dialog
      ...
      width="30%"
    >
      <mannercharge ref="chargedlg" @onclickOK="onStartCharge" @onChargeCancel="onChargeClickCancel" />
    ...
    <el-dialog
      ...
      width="30%"
    >
      <drawbackep ref="drawbackdlg" @onclickOK="onStartDrawBack" @onChargeCancel="onDrawBackClickCancel" />
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      const wb = XLSX.utils.table_to_book(document.querySelector('#meterTable'))
