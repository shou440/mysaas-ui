<template>
  <div class="app-main">
    ...
    <div v-show="search_value==1" id="item8" />
    <div v-show="search_value==1" id="item9" />
    <div v-show="search_value==1" id="item10">
      <el-input v-model="input" size="mini" placeholder="请输入关键字进行过滤" />
    </div>
    <div v-show="search_value==1" id="item11">
      <el-tree
        ref="tree"
        class="filter-tree"
        :data="data"
    ...
    <div v-show="search_value==1" id="item13">
      <el-table
        :data="tableData"
        height="100%"
        border
    ...
    <div v-show="search_value==0" id="item14" />
    <div v-show="search_value==0" id="item15">
      <el-table
        :data="tableData"
        height="100%"
        border
