<template>
  <div class="app-main">
    ...
    <div id="item4"><div id="myChart1" :style="{width: '100%', height: '98%'}" /></div>
    <div id="item5"><div id="myChart2" :style="{width: '100%', height: '98%'}" /></div>
    <div id="item6"><div id="myChart3" :style="{width: '100%', height: '98%'}" /></div>
    <div id="item7"><div id="myChart4" :style="{width: '100%', height: '98%'}" /></div>
  </div>
</template>
