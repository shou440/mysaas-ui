  ...
  <div class="app-main">
    ...
    <div id="top">
      <div id="top_item1">
        ...
        <div id="top_item_t3"><el-select size="mini" /></div>
        <div id="top_item_t4">分类能耗：</div>
        <div id="top_item_t5"><el-select size="mini" /></div>
        <div id="top_item_t6">支路选择：</div>
        <div id="top_item_t7"><el-select size="mini" /></div>
      </div>
      <div id="top_item2">
        <div id="top_item2_t1">环比(单位：kW·h )</div>
        <div id="top_item2_t2"><span class="iconfont icon-dangyuebaofei" style="color:#59C922;font-size:26px" /></div>
        <div id="top_item2_t3"><span class="iconfont icon-lishi" style="color:#4D93FF;font-size:22px" /></div>
        <div id="top_item2_t4"><span class="iconfont icon-trend" style="color:#FFA039;font-size:22px" /></div>
        <div id="top_item2_t5"><span class="iconfont icon-ziyuan" style="color:#FD5248;font-size:26px" /></div>
        <div id="top_item2_t6"><span class="iconfont icon-shuju5" style="color:#01ADA8;font-size:26px" /></div>
        <div id="top_item2_t7"><span class="iconfont icon-qushi" style="color:#4D93FF;font-size:26px" /></div>
        ...
        <div id="top_item2_t13">17.40%<span class="el-icon-caret-bottom" style="font-size:8px;color:green" /></div>
        ...
        <div id="top_item2_t19">-17.98%<span class="el-icon-caret-top" style="font-size:8px;color:red" /></div>
      </div>
      <div id="top_item3">
        <div id="top_item3_t1">日平均负荷曲线</div>
        <div id="top_item3_t2">
          <div id="myChart1" :style="{width: '100%', height: '98%'}" />
        </div>
      </div>
    </div>
    <div id="bottom">
      <div id="bottom_item1">历史趋势</div>
      <div id="bottom_item2"><el-select size="mini" /></div>
      <div id="bottom_item3">
        <div id="myChart2" :style="{width: '100%', height: '98%'}" />
      </div>
    </div>
