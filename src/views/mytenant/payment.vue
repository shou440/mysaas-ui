<template>
  <div class="paymentbody" :style="bodysize">
    ...
    <div class="paymentrow2">
      <van-cell v-for="pay in paymentLst " :key="pay.payment_id" center :label="sqlTimeToStr(pay.time_crt)" :value="getFeeStr(pay.payment_fee/100)">
        <template slot="title">
